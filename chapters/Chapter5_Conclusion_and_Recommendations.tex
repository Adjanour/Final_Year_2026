...
\begin{enumerate}
  ...
  \item \textbf{The non-monotone result is statistically significant.} The WebQSP comparison gives $p < 0.001$ for the Hits@1 drop. Hits@1, precision, and recall each fall by roughly 4 to 6 percentage points, while F1 drops by 10.5 points. The result is not an artefact of any single evaluation measure.
