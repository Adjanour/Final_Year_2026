...
\begin{figure}[htbp]
  ...
  \begin{tikzpicture}
    ...
    \end{axis}
  \end{tikzpicture}
  \caption{Performance comparison on WebQSP. DCA-Trie v1 shows consistent drops of approximately 5pp across all metrics.}
...
\begin{figure}[htbp]
  ...
  \begin{tikzpicture}
    ...
    \end{axis}
  \end{tikzpicture}
  \caption{The non-monotone relationship: tighter filtering reduces SIR but does not improve accuracy.}
