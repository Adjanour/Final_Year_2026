...
The significance of these drops is assessed with the exact binomial McNemar test on
...
($p = 0.77$), showing that static and lazy type-gating behave identically in
...
Calibration shows the mechanism is faithful. With both TypeOracle gates disabled,
...
but Hits@1 drops by 4.0pp (v3 by 4.7pp), both significant. Calibration shows the
...
(100\% agreement, both 147/300 correct, $p=1.0$), showing on a second dataset that
